$("form").find("input[type='text']").bind({
	'blur': function() {
		...
		var errorspan = $this.parent("div").parent("td").next("td").find("span");
		...
		function error_add(text) {
			errorspan.html(text).addClass("error_yellow")
		}
	...
	'focus': function() {
		$this = $(this)
		var errorspan = $this.parent("div").parent("td").next("td").find("span");
		if (errorspan.hasClass("error_yellow")) {
			errorspan.removeClass("error_yellow").html("")
		}
	}
})